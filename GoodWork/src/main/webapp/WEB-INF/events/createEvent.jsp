...
<body>
	...
	<c:choose>
				...
				<div class=" container form-goup jumbotron">
					<form action="createEvent.do" method="POST"
						...
						<div>
							...
							<!--  -->
							<label>Catagory</label> <select class="form-control" name="name">
						...
						placeholder="enter address 2 of event" /><br>
							...
							<label for="event.location.state" class="col-sm-2 control-label">Event
								State</label> <select class="form-control" name="location.state">
					...
					title="Zip Code format 12345 or 12345-1234" class="form-control" name="location.zipCode"/>
							...
							<label for="pocPhone">POC Phone Number</label> <input
								type="phone" class="form-control" name="pocPhone"
							...
							<label for="photoUrl">Photo URL</label> <input type="text"
								class="form-control" name="photoUrl"
								placeholder="enter photo url" /><br>
						</div>
		...
		<c:otherwise>
		You are not logged in. Please log in to Create Event.
		</c:otherwise>
	</c:choose>
	<!--  -->
	<hr>
